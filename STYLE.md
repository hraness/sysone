...
- Sys1's product-specific copy rules (name spelling, the one-line description, the shared nav, and status wording) are in the “Public copy” section of `PRODUCT.md`.
- The primary nav is copied into every HTML file under `site/`. Change all of them in the same commit.
